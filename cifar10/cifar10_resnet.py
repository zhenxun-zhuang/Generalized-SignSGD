...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'resnet218', 'resnet1202']
...
def resnet218(num_classes=10):
    return ResNet(BasicBlock, [36, 36, 36], num_classes)
