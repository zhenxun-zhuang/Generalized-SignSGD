"""
Adapted from https://github.com/pytorch/pytorch/blob/1.6/torch/optim/sgd.py
"""
import torch
...
class SGDClipGrad(Optimizer):
    ...
    The algorithm is from 'Improved Analysis of Clipping Algorithms for
    Non-convex Optimization' (https://arxiv.org/abs/2010.02519).
    ...
    Args:
        ...
        clipping_param (float, optional): control when we clip the gradient
    Example:
        >>> optimizer = torch.optim.SGDClipGrad(model.parameters(), lr=0.1, momentum=0.9)
        >>> optimizer.zero_grad()
    ...
    def __init__(self, params, lr, momentum=0, dampening=0,
                 weight_decay=0, nesterov=False, clipping_param=0):
        if lr and lr < 0.0:
